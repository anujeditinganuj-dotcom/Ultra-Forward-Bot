...
# For Any Kind Of Error Ask Us In Support Group @Silicon_Botz 
     ...
     await query.message.edit_text(
        TEXT.format(_bot_data['name'], _bot_data['id'], _bot_data['username']),
        reply_markup=InlineKeyboardMarkup(buttons))
...
# For Any Kind Of Error Ask Us In Support Group @Silicon_Botz                                              
     ...
     try:
         ...
         await txt.edit_text("**Successfully button added**",
            reply_markup=InlineKeyboardMarkup([
               [InlineKeyboardButton('👀 sᴇᴇ ʙᴜᴛᴛᴏɴ', callback_data="settings#seebutton")],
     ...
     await query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup([
           [InlineKeyboardButton('✚ ᴀᴅᴅ ʙᴜᴛᴛᴏɴ ✚', callback_data="settings#addbutton")],
           [InlineKeyboardButton('↩ Back', callback_data="settings#main")]
        ]))
